...
H('div#root-node', {}, (h, path) => {
  actionModule
    .action$
    .skipRepeatsWith((a, b) => a.action === b.action)
    .observe(x => console.log(x))
  h('div', {on: {drop: 'drop', dragover: 'dragover'}}, h => h('Drop Zone'))
  h('button', {on: {click: 'load', drop: 'drop', dragover: 'dragover'}}, h => h('load'))
  h('div', {}, action$(path)
